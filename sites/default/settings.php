 ...
 *  - DRUPAL_DB:    Primary Drupal database name.
 *  - CALENDAR_DB:  Optional secondary database name for calendar data.
 *  - DB_USER:      Database username.
 *  - DB_PASSWORD:  Database password.
 *  - DB_HOST:      Database host (e.g. "mariadb" or "localhost").
 *  - DB_PORT:      Database port (default: 3306).
 *  - DB_DRIVER:    Database driver (default: "mysql").
 */
$databases = [];

$env_db_driver   = getenv('DB_DRIVER') ?: 'mysql';
$env_db_host     = getenv('DB_HOST') ?: 'localhost';
$env_db_port     = getenv('DB_PORT') ?: '3306';
$env_db_user     = getenv('DB_USER') ?: '';
$env_db_password = getenv('DB_PASSWORD') ?: '';
$env_drupal_db   = getenv('DRUPAL_DB') ?: '';
$env_calendar_db = getenv('CALENDAR_DB') ?: '';

$databases['default']['default'] = [
  'database'  => $env_drupal_db,
  ...
  'driver'    => $env_db_driver,
];

// Optional secondary database connection for calendar or other data.
if (!empty($env_calendar_db)) {
  $databases['default']['calendar'] = [
    'database' => $env_calendar_db,
    'username' => $env_db_user,
    'password' => $env_db_password,
    'host'     => $env_db_host,
    'port'     => $env_db_port,
 ...
 * @endcode
 */
$settings['hash_salt'] = 'lxS0v9OJhFraOrSu1-sag5XdSmX1Gq0bJTUV7_mGF5a_cN8Qdp9mYXzDeTKSHbXJmpW-RQGWWw';
...
$settings['config_sync_directory'] = 'sites/default/files/config_NrS0PGlnCD5-GHVmcv2YsHsxFMBNRHvdrMzLX9aPiOiGKLKuDmLyDFAXiLrzZ-Cg1ZoXqjFw6w/sync';
